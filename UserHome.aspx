<%@ Page Title="我的相册" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UserHome.aspx.cs" Inherits="UserHome" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .showdiv {
            ...
            padding-right: 10px;
            padding-bottom: 5px;
            border-color: #b794672e;
            background-image: linear-gradient(#4bc3e52b, #e5a89126);
        }
...
<asp:Content ID="BodyContent1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height: 40px; padding: 100px 15px 15px 15px; background-color: lightblue">

        <div id="welc">
            <asp:Label runat="server" ID="timeLabel" Text="欢迎来到MyBlog!" Font-Bold="true"></asp:Label>
    ...
    <div class="showdiv" id="Img1" runat="server">
        ...
        <br />
        <asp:LinkButton ID="DeleteBtn1" runat="server" OnClick="DeleteBtn1_Click" ToolTip="删除这张图片" ForeColor="Red">删除</asp:LinkButton>
        <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" ToolTip="修改图片分类" ForeColor="#996600" Height="25px" Width="60px">
    ...
    <div class="showdiv" id="Img2" runat="server">
        ...
        <asp:LinkButton ID="DeleteBtn2" runat="server" OnClick="DeleteBtn2_Click" ToolTip="删除这张图片" ForeColor="Red">删除</asp:LinkButton>
        <asp:DropDownList ID="DropDownList2" runat="server" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" ToolTip="修改图片分类" ForeColor="#996600" Height="25px" Width="60px">
            <asp:ListItem>风景</asp:ListItem>
            <asp:ListItem>生活</asp:ListItem>
            <asp:ListItem>人物</asp:ListItem>
            <asp:ListItem>插画</asp:ListItem>
